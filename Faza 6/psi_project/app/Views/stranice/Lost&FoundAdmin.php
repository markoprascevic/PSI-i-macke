...
Stranica za prikaz Lost&Found oglasa za admina
@version 1.0
---->
...
<form name="pretragaLF" method="GET" action="lfPretrazi" style="background-color: rgba(148,69,69,0.1)">
    <div class="row" style="padding-top: 1%; padding-bottom: 1%">
         <div class="col-sm-3" style="text-align: center; width: 100%; padding-left: 3%">
            ...
            <div class="col-sm-2">
                <input type="text" id="rasa" class = "form-control" name="rasa" value="" placeholder="Unesite rasu">
            </div>
            ...
            <div class="col-sm-2" style="text-align: center; padding-right: 3%">
                <?php echo anchor("Admin/postaviLF",'<input type="button" class = "form-control" id="postaviLF" name="postavuLF" value="Postavi oglas">');?>
            </div>
    </div>  
</form>
...
$pitanje = 'Da li ste sigurni da zelite da obrisete oglas?';
foreach ($oglasi as $oglas) {
    ...
    if(($i % 2)==0){
        ...
        echo anchor("$controller/brisiOglas/{$glavna->oglasId}",'<input type="image" onclick="return confirm(\' Da li ste sigurni da zelite da obrisete objavu? \');" style=" width:30px" src='.$putanja.'></i><hr></td></tr>');
        echo '<tr><td><i><u>Korisnik:</u> </i>'.$glavna->username.'</td></tr><tr><td style="width:30%;"><img style="width:100%;" src="data:image/jpeg;base64,'.base64_encode( $glavna->slika ).'"/></td></tr><tr><td><table class="table-bordered"><tr><td><table class="table"><tr><td><i><u>Vrsta: </u></i>'.$glavna->vrsta.'</td></tr><tr><td><i><u>Pol: </u></i>'.$glavna->pol.'</td></tr><tr><td><i><u>Rasa: </u></i>'.$glavna->rasa.'</td></tr></table></td><td><table class="table"><tr><td><i><u>Opis:</u></i></td></tr><tr><td style="padding-left:1%; text-align: justify; font-size: 18px; font-weight: 400" >'.$glavna->opis. '</td></tr></table></td></tr></table></td></tr></table></td>';
    }
    else {
