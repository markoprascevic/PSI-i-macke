...
<form name="pretragaLF" method="GET" action="lfPretrazi" style="background-color: rgba(148,69,69,0.1)">
    <div class="row" style="padding-top: 1%; padding-bottom: 1%">
         <div class="col-sm-4" style="text-align: center">
                ...
                Izgubljen
                <input type="radio" id="izgubljen" name="izgpro" value="pronadjen">
                Pronađen 
                <input type="radio" id="izgubljen" name="izgpro" value="%" checked>
                Oba
            </div>
            ...
            <div class="col-sm-2" style="text-align: center">
                <?php echo anchor("Admin/postaviLF",'<input type="button" id="postaviLF" name="postavuLF" value="Postavi oglas">');?>
            </div>
    </div>  
</form>
...
foreach ($oglasi as $oglas) {
    ...
    if(($i % 2)==0){
        ...
        echo anchor("$controller/brisiOglas/{$glavna->oglasId}",'<img style=" width:30px" src='.$putanja.'></i><hr></td></tr>');
