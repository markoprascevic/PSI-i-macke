...
Stranica za prikaz Udomi oglasa
@version 1.0
---->
...
<form name="pretragaLF" method="GET" action="udomiPretrazi" style="background-color: rgba(148,69,69,0.1)">
    <div class="row" style="padding-top: 1%; padding-bottom: 1%">
            ...
            <div class="col-sm-2" style="text-align: center">
                 <?php echo anchor("Korisnik/udomiPostavi",'<input type="button" id="postaviLF" class="form-control" name="postavuLF" value="Postavi oglas">'); ?>
            </div>
    </div>  
</form>
...
foreach ($oglasi as $oglas) {
    ...
    if(($i % 2)==0){
        echo '<tr style="background-color: rgba(148,69,69,0.04)"><td><table class="table-borderless"><tr><td><i><u>Korisnik:</u> </i>'.$glavna->username.'</td></tr><tr><td style="width:30%;"><img style="width:100%;" src="data:image/jpeg;base64,'.base64_encode( $glavna->slika ).'"/></td></tr><tr><td><table class="table-bordered"><tr><td><table class="table"><tr><td><i><u>Vrsta: </u></i>'.$glavna->vrsta.'</td></tr><tr><td><i><u>Pol: </u></i>'.$glavna->pol.'</td></tr><tr><td><i><u>Rasa: </u></i>'.$glavna->rasa.'</td></tr><tr><td><i><u>Starost: </u></i>'.$oglas->starost.'</td></tr><tr><td><i><u>Mesto: </u></i>'.$oglas->mesto.'</td></tr></table></td><td><table class="table"><tr><td><i><u>Opis:</u></i></td></tr><tr><td style="padding-left:1%; text-align: justify; font-size: 18px; font-weight: 400" >'.$glavna->opis. '</td></tr></table></td></tr></table></td></tr></table></td>';
    }
    else {
        
        echo '<td><table class="table-borderless"><tr><td><i><u>Korisnik:</u> </i>'.$glavna->username.'</td></tr><tr><td style="width:30%;"><img style="width:100%;" src="data:image/jpeg;base64,'.base64_encode( $glavna->slika ).'"/></td></tr><tr><td><table class="table-bordered"><tr><td><table class="table"><tr><td><i><u>Vrsta: </u></i>'.$glavna->vrsta.'</td></tr><tr><td><i><u>Pol: </u></i>'.$glavna->pol.'</td></tr><tr><td><i><u>Rasa: </u></i>'.$glavna->rasa.'</td></tr><tr><td><i><u>Starost: </u></i>'.$oglas->starost.'</td></tr><tr><td><i><u>Mesto: </u></i>'.$oglas->mesto.'</td></tr></table></td><td><table class="table"><tr><td><i><u>Opis:</u></i></td></tr><tr><td style="padding-left:1%; text-align: justify; font-size: 18px; font-weight: 400" >'.$glavna->opis. '</td></tr></table></td></tr></table></td></tr></table></td></tr>';
    }
    $i=$i+1;
}   
if(($i % 2)==0)    echo '</tr>';
