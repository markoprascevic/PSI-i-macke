...
foreach ($oglasi as $oglas) {
    ...
    if(($i % 2)==0){
        ...
        echo anchor("$controller/brisanje/{$oglas->oglasId}",'<img style=" width:30px" src='.$putanja.'></i><hr></td></tr>');
        echo '<tr><td><i><u>Korsnik:</u> </i>'.$oglas->username.'</td></tr><tr><td style="width:30%;"><img style="width:100%;" src="data:image/jpeg;base64,'.base64_encode( $oglas->slika ).'"/></td></tr><tr><td><table class="table-bordered"><tr><td><table class="table"><tr><td><i><u>Vrsta: </u></i>'.$oglas->vrsta.'</td></tr><tr><td><i><u>Pol: </u></i>'.$oglas->pol.'</td></tr><tr><td><i><u>Rasa: </u></i>'.$oglas->rasa.'</td></tr></table></td><td><table class="table"><tr><td><i><u>Opis:</u></i></td></tr><tr><td style="padding-left:1%; text-align: justify; font-size: 18px; font-weight: 400" >'.$oglas->opis. '</td></tr></table></td></tr></table></td></tr></table></td>';
    }
    else {
