                    ...
                    <div class="offset-sm-2 col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-sm-9" style="margin:0px; margin-top:35px !important; padding: 0px;">
                                ...
                                <?php echo anchor("$controller/nemaPristupS",'<button style=" font-size:23px; height: 50px; width: 190px; border: solid red 2px; background-color: RGB(254,44,1);" type="button" name="SrecnePrice" class="btn btn-danger button4 buttoni">SrecnePrice</button>'); ?>
                                <?php echo anchor("$controller/nemaPristupZ",'<button style=" font-size:23px; height: 50px; width: 190px; border: solid red 2px; background-color: RGB(254,44,1);" type="button" name="Zalbe" class="btn btn-danger button5 buttoni">Zalbe</button>'); ?>
                            </div>
