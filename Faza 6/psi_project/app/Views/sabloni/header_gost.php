                    ...
                    <div class="offset-sm-2 col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-sm-9" style="margin:0px; margin-top:35px !important; padding: 0px;">
                                ...
                                <?php echo anchor("Error404",'<button style=" font-size:23px; height: 50px; width: 190px; border: solid red 2px; background-color: RGB(254,44,1);" type="button" name="Udomi" class="btn btn-danger button3 buttoni">Udomi</button>'); ?>
                                <?php echo anchor("Error404",'<button style=" font-size:23px; height: 50px; width: 190px; border: solid red 2px; background-color: RGB(254,44,1);" type="button" name="SrecnePrice" class="btn btn-danger button4 buttoni">SrecnePrice</button>'); ?>
                                <?php echo anchor("Error404",'<button style=" font-size:23px; height: 50px; width: 190px; border: solid red 2px; background-color: RGB(254,44,1);" type="button" name="Zalbe" class="btn btn-danger button5 buttoni">Zalbe</button>'); ?>
                            </div>
                            <div class="offset-sm-1 col-sm-1" style="margin-top: 20px; text-align: right">
                                <?php echo '<a href="#"><img style="width:40px; " src="data:image/jpeg;base64,'.base64_encode( $slike[0]->slika ).'"/></a>';?>
                            </div>
                            <div class="col-sm-1" style="margin-top: 20px;">
                                <?php echo '<a href="#"><img style="width:40px; " src="data:image/jpeg;base64,'.base64_encode( $slike[1]->slika ).'"/></a>';?>
                            </div>
                        </div> 
                    </div>
                </div>   
