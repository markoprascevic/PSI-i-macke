                    ...
                    <div class="offset-sm-2 col-sm-9">
                        ...
                        <div class="row" >
                            <div class="col-sm-8" style="padding-top: 35px; ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2" style="padding: 0px;">
                                        <?php echo anchor("$controller/zalbaPostavi",'<button style=" font-size:23px; height: 50px; width: 100%; border: solid red 2px; background-color: RGB(254,44,1);" type="button" name="Zalbe" class="btn btn-danger button5 buttoni">Žalbe</button>'); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-2" style="margin-top: 20px; text-align: center;">
                                <?php echo anchor("Korisnik/profil",'<img style="width:20%; margin-right:10% " src="data:image/jpeg;base64,'.base64_encode( $slike[5]->slika ).'">');?>
                           
                                <?php echo anchor("Korisnik/logout",'<img style="width:20%; " src="data:image/jpeg;base64,'.base64_encode( $slike[6]->slika ).'">');?>
                            </div>
                        </div> 
                    </div> 
                </div>
