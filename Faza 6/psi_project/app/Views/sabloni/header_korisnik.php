                            ...
                            <div class="col-sm-8" style="padding-top: 35px; ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2" style="padding: 0px;">
                                        <?php echo anchor("$controller/zalbaPostavi",'<button style=" font-size:auto; height: 50px; width: 100%; border: solid red 2px; background-color: RGB(254,44,1);" type="button" name="Zalbe" class="btn btn-danger button5 buttoni">Žalbe</button>'); ?>
                                    </div>
                                </div>
                            </div>
